...
export const plants: PlantRecord = {
  ...
  "bellflower": {
    ...
    "description": "Bellflower is a diverse genus of flowering plants known for their bell-shaped blooms. They come in various species and are valued for their ornamental qualities in gardens and landscapes."
  },
  "black-eyed-susan": {
    "id": "black-eyed-susan",
